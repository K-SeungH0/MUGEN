...
void King::Init()
{
	...
	motions[(int)CHARACTER_STATE::IDLE].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT,CHARACTER_STATE::IDLE);
	motions[(int)CHARACTER_STATE::IDLE].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::IDLE);
	...
	motions[(int)CHARACTER_STATE::MOVE].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT, CHARACTER_STATE::MOVE);
	motions[(int)CHARACTER_STATE::MOVE].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::MOVE);
	...
	motions[(int)CHARACTER_STATE::MOVE_GUARD].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT, CHARACTER_STATE::MOVE_GUARD);
	motions[(int)CHARACTER_STATE::MOVE_GUARD].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::MOVE_GUARD);
	...
	motions[(int)CHARACTER_STATE::GUARD].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT, CHARACTER_STATE::GUARD);
	motions[(int)CHARACTER_STATE::GUARD].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::GUARD);
	...
	motions[(int)CHARACTER_STATE::HIT].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT, CHARACTER_STATE::HIT);
	motions[(int)CHARACTER_STATE::HIT].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::HIT);
	...
	motions[(int)CHARACTER_STATE::DEATH].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT, CHARACTER_STATE::DEATH);
	motions[(int)CHARACTER_STATE::DEATH].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::DEATH);
	...
	motions[(int)CHARACTER_STATE::ATTACK_WEAK].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT, CHARACTER_STATE::ATTACK_WEAK);
	motions[(int)CHARACTER_STATE::ATTACK_WEAK].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::ATTACK_WEAK);
	...
	motions[(int)CHARACTER_STATE::ATTACK_STRONG].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT, CHARACTER_STATE::ATTACK_STRONG);
	motions[(int)CHARACTER_STATE::ATTACK_STRONG].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::ATTACK_STRONG);
	...
	motions[(int)CHARACTER_STATE::ATTACK_KICK].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT, CHARACTER_STATE::ATTACK_KICK);
	motions[(int)CHARACTER_STATE::ATTACK_KICK].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::ATTACK_KICK);
	...
	motions[(int)CHARACTER_STATE::ATTACK_RANGE].lpImages[(int)CHARACTER_DIRECTION::RIGHT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::RIGHT, CHARACTER_STATE::ATTACK_RANGE);
	motions[(int)CHARACTER_STATE::ATTACK_RANGE].lpImages[(int)CHARACTER_DIRECTION::LEFT] = ImageManager::GetLpInstance()->GetImage(name, CHARACTER_DIRECTION::LEFT, CHARACTER_STATE::ATTACK_RANGE);
